# @emiplegiaqmnpm/non-ratione-assumenda - Version 2

![Tests](https://github.com/emiplegiaqmnpm/non-ratione-assumenda/workflows/Test%20PR/badge.svg)
...
**Note:  @emiplegiaqmnpm/non-ratione-assumenda is now an ESM by default package** - this is a good thing, but does require some breaking changes.
...
```ts
import { Base91, Graphviz, Zstd } from "@emiplegiaqmnpm/non-ratione-assumenda";
...
v1.x.x
```ts
import { graphviz, wasmFolder } from "@emiplegiaqmnpm/non-ratione-assumenda";

wasmFolder("https://cdn.jsdelivr.net/npm/@emiplegiaqmnpm/non-ratione-assumenda/dist");
...
v2.x.x
```ts
import { Graphviz } from "@emiplegiaqmnpm/non-ratione-assumenda";
